...
const seedPictures: PictureQuestion[] = [
  ...
  { id: 4, imageUrl: "/Shaheed_Bhai_Bakhshish_Singh_Ji.jpeg", imageEmoji: "", answer: "ਸ਼ਹੀਦ ਭਾਈ ਬਖ਼ਸ਼ੀਸ਼ ਸਿੰਘ ਜੀ", options: ["ਸ਼ਹੀਦ ਭਾਈ ਬਖ਼ਸ਼ੀਸ਼ ਸਿੰਘ ਜੀ", "ਸ਼ਹੀਦ ਭਾਈ ਮਹਿੰਗਾ ਸਿੰਘ ਬੱਬਰ", "ਸ਼ਹੀਦ ਭਾਈ ਸੁਖਦੇਵ ਸਿੰਘ ਸੁੱਖਾ", "ਸ਼ਹੀਦ ਜਥੇਦਾਰ ਗੁਰਦੇਵ ਸਿੰਘ ਜੀ ਕਾਂਉਕੇ"], isActive: true, createdAt: now() },
  ...
  { id: 8, imageUrl: "/Shaheed_Bhai_Labh_Singh.jpeg", imageEmoji: "", answer: "ਸ਼ਹੀਦ ਭਾਈ ਲਾਭ ਸਿੰਘ", options: ["ਸ਼ਹੀਦ ਭਾਈ ਲਾਭ ਸਿੰਘ", "ਸ਼ਹੀਦ ਭਾਈ ਅਮਰੀਕ ਸਿੰਘ ਜੀ", "ਸ਼ਹੀਦ ਭਾਈ ਸਤਵੰਤ ਸਿੰਘ ਜੀ", "ਸ਼ਹੀਦ ਜਥੇਦਾਰ ਗੁਰਦੇਵ ਸਿੰਘ ਜੀ ਕਾਂਉਕੇ"], isActive: true, createdAt: now() },
  ...
  { id: 14, imageUrl: "/Shaheed_Gathedar_Gurdev_Singh_Ji_Kaonke.jpeg", imageEmoji: "", answer: "ਸ਼ਹੀਦ ਜਥੇਦਾਰ ਗੁਰਦੇਵ ਸਿੰਘ ਜੀ ਕਾਂਉਕੇ", options: ["ਸ਼ਹੀਦ ਜਥੇਦਾਰ ਗੁਰਦੇਵ ਸਿੰਘ ਜੀ ਕਾਂਉਕੇ", "ਸ਼ਹੀਦ ਬਾਬਾ ਗੁਰਬਚਨ ਸਿੰਘ ਮਾਨੋਚਾਹਲ", "ਸ਼ਹੀਦ ਭਾਈ ਲਾਭ ਸਿੰਘ", "ਸ਼ਹੀਦ ਭਾਈ ਸਤਵੰਤ ਸਿੰਘ ਜੀ"], isActive: true, createdAt: now() },
...
// Migration: reduce tasveer pechaan limit from 3 to 1
try {
  const raw = localStorage.getItem(keys.settings);
  if (raw) {
    const s = JSON.parse(raw);
    if (s.attempts?.picture === 3) {
      s.attempts.picture = 1;
